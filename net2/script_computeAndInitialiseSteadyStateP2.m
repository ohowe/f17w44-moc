...
lgg=zeros(8,1); %vector for loss coeficients at each fixture
...
lossCoeff(5,1) = lossCoeff(1,2) + lossCoeff(5,1);
...
lossCoeff(12,1) = lossCoeff(9,2) + lossCoeff(10,2) + lossCoeff(12,1);
...
pipe(2,1).Qo = (Qss(1)+Qss(2)) * ones(pipe(2,1).Nx/2+1,1);
pipe(2,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(2,1).Nx/2]' * 2 * pipe(2,1).R * (Qss(1)+Qss(2)) ^ 2;
pipe(2,2).Qo = (Qss(1)+Qss(2)) * ones(pipe(2,2).Nx/2+1,1);
pipe(2,2).Ho = pipe(2,1).Ho(pipe(2,1).Nx/2+1) - [0:pipe(2,2).Nx/2]' * 2 * pipe(2,2).R * (Qss(1)+Qss(2)) ^ 2;
...
pipe(4,1).Qo = Qss(2) * ones(pipe(4,1).Nx/2+1,1);
pipe(4,1).Ho = pipe(2,2).Ho(pipe(2,2).Nx/2+1) - [0:pipe(4,1).Nx/2]' * 2 * pipe(4,1).R * Qss(2) ^ 2;
pipe(4,2).Qo = Qss(2) * ones(pipe(4,2).Nx/2+1,1);
pipe(4,2).Ho = pipe(4,1).Ho(pipe(4,1).Nx/2+1) - [0:pipe(4,2).Nx/2]' * 2 * pipe(4,2).R * Qss(2) ^ 2;

pipe(5,1).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)+Qss(8)) * ones(pipe(5,1).Nx/2+1,1);
pipe(5,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(5,1).Nx/2]' * 2 * pipe(5,1).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)+Qss(8)) ^ 2;
pipe(5,2).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)+Qss(8)) * ones(pipe(5,2).Nx/2+1,1);
pipe(5,2).Ho = pipe(5,1).Ho(pipe(5,1).Nx/2+1) - [0:pipe(5,2).Nx/2]' * 2 * pipe(5,2).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)+Qss(8)) ^ 2;

pipe(6,1).Qo = (Qss(3)+Qss(4)+(Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(6,1).Nx/2+1,1);
pipe(6,1).Ho = pipe(5,2).Ho(pipe(5,2).Nx/2+1) - [0:pipe(6,1).Nx/2]' * 2 * pipe(6,1).R * (Qss(3)+Qss(4)+(Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;
pipe(6,2).Qo = (Qss(3)+Qss(4)+(Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(6,2).Nx/2+1,1);
pipe(6,2).Ho = pipe(6,1).Ho(pipe(6,1).Nx/2+1) - [0:pipe(6,2).Nx/2]' * 2 * pipe(6,2).R * (Qss(3)+Qss(4)+(Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;
...
pipe(9,1).Qo = ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(9,1).Nx/2+1,1);
pipe(9,1).Ho = pipe(6,2).Ho(pipe(6,2).Nx/2+1) - [0:pipe(9,1).Nx/2]' * 2 * pipe(9,1).R * ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;
pipe(9,2).Qo = ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(9,2).Nx/2+1,1);
pipe(9,2).Ho = pipe(9,1).Ho(pipe(9,1).Nx/2+1) - [0:pipe(9,2).Nx/2]' * 2 * pipe(9,2).R * ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;

pipe(10,1).Qo = ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(10,1).Nx/2+1,1);
pipe(10,1).Ho = pipe(5,2).Ho(pipe(5,2).Nx/2+1) - [0:pipe(10,1).Nx/2]' * 2 * pipe(10,1).R * ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;
pipe(10,2).Qo = ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) * ones(pipe(10,2).Nx/2+1,1);
pipe(10,2).Ho = pipe(10,1).Ho(pipe(10,1).Nx/2+1) - [0:pipe(10,2).Nx/2]' * 2 * pipe(10,2).R * ((Qss(5)+Qss(6)+Qss(7)+Qss(8))/2) ^ 2;

pipe(11,1).Qo = (Qss(5)) * ones(pipe(11,1).Nx/2+1,1);
pipe(11,1).Ho = (pipe(9,2).Ho(pipe(9,2).Nx/2+1)+pipe(10,2).Ho(pipe(10,2).Nx/2+1))/2 - [0:pipe(11,1).Nx/2]' * 2 * pipe(2,1).R * (Qss(5)) ^ 2;
...
pipe(12,1).Qo = (Qss(6)+Qss(7)+Qss(8)) * ones(pipe(12,1).Nx/2+1,1);
pipe(12,1).Ho = (pipe(9,2).Ho(pipe(9,2).Nx/2+1)+pipe(10,2).Ho(pipe(10,2).Nx/2+1))/2 - [0:pipe(12,1).Nx/2]' * 2 * pipe(12,1).R * (Qss(6)+Qss(7)+Qss(8)) ^ 2;
pipe(12,2).Qo = (Qss(6)+Qss(7)+Qss(8)) * ones(pipe(12,2).Nx/2+1,1);
pipe(12,2).Ho = pipe(12,1).Ho(pipe(12,1).Nx/2+1) - [0:pipe(12,2).Nx/2]' * 2 * pipe(12,2).R * (Qss(6)+Qss(7)+Qss(8)) ^ 2;

pipe(13,1).Qo = (Qss(6)) * ones(pipe(13,1).Nx/2+1,1);
pipe(13,1).Ho = pipe(12,2).Ho(pipe(12,2).Nx/2+1) - [0:pipe(13,1).Nx/2]' * 2 * pipe(13,1).R * (Qss(6)) ^ 2;
pipe(13,2).Qo = (Qss(6)) * ones(pipe(13,2).Nx/2+1,1);
...
pipe(15,1).Qo = (Qss(8)) * ones(pipe(15,1).Nx/2+1,1);
pipe(15,1).Ho = pipe(12,2).Ho(pipe(12,2).Nx/2+1) - [0:pipe(15,1).Nx/2]' * 2 * pipe(15,1).R * (Qss(8)) ^ 2;
pipe(15,2).Qo = (Qss(8)) * ones(pipe(15,2).Nx/2+1,1);
pipe(15,2).Ho = pipe(15,1).Ho(pipe(15,1).Nx/2+1) - [0:pipe(15,2).Nx/2]' * 2 * pipe(15,2).R * (Qss(8)) ^ 2;
