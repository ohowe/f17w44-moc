...
lossCoeff(4,1) = lossCoeff(1,2) + lossCoeff(4,1);
...
lossCoeff(12,1) = lossCoeff(10,2) + lossCoeff(12,1);
lossCoeff(12,2) = lossCoeff(12,1) + lossCoeff(12,2);
lossCoeff(13,1) = lossCoeff(12,2) + lossCoeff(3,2) + lossCoeff(13,1);
...
Qss = zeros(6,1);%Flow at steady state (vector size is number of downstream fixture points)
...
pipe(3,1).Qo = (Qss(6)/2) * ones(pipe(3,1).Nx/2+1,1);
pipe(3,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(3,1).Nx/2]' * 2 * pipe(3,1).R * (Qss(6)/2) ^ 2;
pipe(3,2).Qo = (Qss(6)/2) * ones(pipe(3,2).Nx/2+1,1);
pipe(3,2).Ho = pipe(3,1).Ho(pipe(3,1).Nx/2+1) - [0:pipe(3,2).Nx/2]' * 2 * pipe(3,2).R * (Qss(6)/2) ^ 2;

pipe(4,1).Qo = (Qss(2)+Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(4,1).Nx/2+1,1);
pipe(4,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(4,1).Nx/2]' * 2 * pipe(4,1).R * (Qss(2)+Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
pipe(4,2).Qo = (Qss(2)+Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(4,2).Nx/2+1,1);
pipe(4,2).Ho = pipe(4,1).Ho(pipe(4,1).Nx/2+1) - [0:pipe(4,2).Nx/2]' * 2 * pipe(4,2).R * (Qss(2)+Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
...
pipe(6,1).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(6,1).Nx/2+1,1);
pipe(6,1).Ho = pipe(4,2).Ho(pipe(4,2).Nx/2+1) - [0:pipe(6,1).Nx/2]' * 2 * pipe(6,1).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
pipe(6,2).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(6,2).Nx/2+1,1);
pipe(6,2).Ho = pipe(6,1).Ho(pipe(6,1).Nx/2+1) - [0:pipe(6,2).Nx/2]' * 2 * pipe(6,2).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
...
pipe(8,1).Qo = (Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(8,1).Nx/2+1,1);
pipe(8,1).Ho = pipe(6,2).Ho(pipe(6,2).Nx/2+1) - [0:pipe(8,1).Nx/2]' * 2 * pipe(8,1).R * (Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
pipe(8,2).Qo = (Qss(4)+Qss(5)+Qss(6)/2) * ones(pipe(8,2).Nx/2+1,1);
pipe(8,2).Ho = pipe(8,1).Ho(pipe(8,1).Nx/2+1) - [0:pipe(8,2).Nx/2]' * 2 * pipe(8,2).R * (Qss(4)+Qss(5)+Qss(6)/2) ^ 2;
...
pipe(10,1).Qo = (Qss(5)+Qss(6)/2) * ones(pipe(10,1).Nx/2+1,1);
pipe(10,1).Ho = pipe(8,2).Ho(pipe(8,2).Nx/2+1) - [0:pipe(10,1).Nx/2]' * 2 * pipe(10,1).R * (Qss(5)+Qss(6)/2) ^ 2;
pipe(10,2).Qo = (Qss(5)+Qss(6)/2) * ones(pipe(10,2).Nx/2+1,1);
pipe(10,2).Ho = pipe(10,1).Ho(pipe(10,1).Nx/2+1) - [0:pipe(10,2).Nx/2]' * 2 * pipe(10,2).R * (Qss(5)+Qss(6)/2) ^ 2;
...
pipe(12,1).Qo = (Qss(6)/2) * ones(pipe(12,1).Nx/2+1,1);
pipe(12,1).Ho = pipe(10,2).Ho(pipe(10,2).Nx/2+1) - [0:pipe(12,1).Nx/2]' * 2 * pipe(12,1).R * (Qss(6)/2) ^ 2;
pipe(12,2).Qo = (Qss(6)/2) * ones(pipe(12,2).Nx/2+1,1);
pipe(12,2).Ho = pipe(12,1).Ho(pipe(12,1).Nx/2+1) - [0:pipe(12,2).Nx/2]' * 2 * pipe(12,2).R * (Qss(6)/2) ^ 2;

pipe(13,1).Qo = (Qss(6)) * ones(pipe(13,1).Nx/2+1,1);
pipe(13,1).Ho = (pipe(12,2).Ho(pipe(12,2).Nx/2+1) + pipe(3,2).Ho(pipe(3,2).Nx/2+1))/2 - [0:pipe(13,1).Nx/2]' * 2 * pipe(13,1).R * (Qss(6)) ^ 2;
