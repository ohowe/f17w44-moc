...
pipe(2,1).Qo = (Qss(1)) * ones(pipe(2,1).Nx/2+1,1);
pipe(2,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(2,1).Nx/2]' * 2 * pipe(2,1).R * (Qss(1)) ^ 2;
pipe(2,2).Qo = (Qss(1)) * ones(pipe(2,2).Nx/2+1,1);
pipe(2,2).Ho = pipe(2,1).Ho(pipe(2,1).Nx/2+1) - [0:pipe(2,2).Nx/2]' * 2 * pipe(2,2).R * (Qss(1)) ^ 2;

pipe(3,1).Qo = (sum(Qss)-Qss(1)) * ones(pipe(3,1).Nx/2+1,1);
pipe(3,1).Ho = pipe(1,2).Ho(pipe(1,2).Nx/2+1) - [0:pipe(3,1).Nx/2]' * 2 * pipe(3,1).R * (sum(Qss)-Qss(1)) ^ 2;
...
pipe(4,1).Ho = pipe(3,2).Ho(pipe(3,2).Nx/2+1) - [0:pipe(4,1).Nx/2]' * 2 * pipe(4,1).R * Qss(2) ^ 2;
pipe(4,2).Qo = Qss(2) * ones(pipe(4,2).Nx/2+1,1);
pipe(4,2).Ho = pipe(4,1).Ho(pipe(4,1).Nx/2+1) - [0:pipe(4,2).Nx/2]' * 2 * pipe(4,2).R * Qss(2) ^ 2;

pipe(5,1).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)) * ones(pipe(5,1).Nx/2+1,1);
pipe(5,1).Ho = pipe(3,2).Ho(pipe(3,2).Nx/2+1) - [0:pipe(5,1).Nx/2]' * 2 * pipe(5,1).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)) ^ 2;
pipe(5,2).Qo = (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)) * ones(pipe(5,2).Nx/2+1,1);
pipe(5,2).Ho = pipe(5,1).Ho(pipe(5,1).Nx/2+1) - [0:pipe(5,2).Nx/2]' * 2 * pipe(5,2).R * (Qss(3)+Qss(4)+Qss(5)+Qss(6)+Qss(7)) ^ 2;

pipe(6,1).Qo = (Qss(3)) * ones(pipe(6,1).Nx/2+1,1);
pipe(6,1).Ho = pipe(5,2).Ho(pipe(5,2).Nx/2+1) - [0:pipe(6,1).Nx/2]' * 2 * pipe(6,1).R * (Qss(3)) ^ 2;
pipe(6,2).Qo = (Qss(3)) * ones(pipe(6,2).Nx/2+1,1);
pipe(6,2).Ho = pipe(6,1).Ho(pipe(6,1).Nx/2+1) - [0:pipe(6,2).Nx/2]' * 2 * pipe(6,2).R * (Qss(3)) ^ 2;

pipe(7,1).Qo = (Qss(4)+Qss(5)+Qss(6)+Qss(7)) * ones(pipe(7,1).Nx/2+1,1);
pipe(7,1).Ho = pipe(6,2).Ho(pipe(6,2).Nx/2+1) - [0:pipe(7,1).Nx/2]' * 2 * pipe(7,1).R * (Qss(4)+Qss(5)+Qss(6)+Qss(7)) ^ 2;
pipe(7,2).Qo = (Qss(4)+Qss(5)+Qss(6)+Qss(7)) * ones(pipe(7,2).Nx/2+1,1);
pipe(7,2).Ho = pipe(7,1).Ho(pipe(7,1).Nx/2+1) - [0:pipe(7,2).Nx/2]' * 2 * pipe(7,2).R * (Qss(4)+Qss(5)+Qss(6)+Qss(7)) ^ 2;

pipe(8,1).Qo = (Qss(4)+Qss(5)) * ones(pipe(8,1).Nx/2+1,1);
pipe(8,1).Ho = pipe(7,2).Ho(pipe(7,2).Nx/2+1) - [0:pipe(8,1).Nx/2]' * 2 * pipe(8,1).R * (Qss(4)+Qss(5)) ^ 2;
pipe(8,2).Qo = (Qss(4)+Qss(5)) * ones(pipe(8,2).Nx/2+1,1);
pipe(8,2).Ho = pipe(8,1).Ho(pipe(8,1).Nx/2+1) - [0:pipe(8,2).Nx/2]' * 2 * pipe(8,2).R * (Qss(4)+Qss(5)) ^ 2;
...
pipe(10,1).Qo = (Qss(5)) * ones(pipe(10,1).Nx/2+1,1);
pipe(10,1).Ho = pipe(8,2).Ho(pipe(8,2).Nx/2+1) - [0:pipe(10,1).Nx/2]' * 2 * pipe(10,1).R * (Qss(5)) ^ 2;
pipe(10,2).Qo = (Qss(5)) * ones(pipe(10,2).Nx/2+1,1);
pipe(10,2).Ho = pipe(10,1).Ho(pipe(10,1).Nx/2+1) - [0:pipe(10,2).Nx/2]' * 2 * pipe(10,2).R * (Qss(5)) ^ 2;

pipe(11,1).Qo = (Qss(5)) * ones(pipe(11,1).Nx/2+1,1);
pipe(11,1).Ho = pipe(10,2).Ho(pipe(10,2).Nx/2+1) - [0:pipe(11,1).Nx/2]' * 2 * pipe(11,1).R * (Qss(5)) ^ 2;
...
pipe(12,1).Qo = (Qss(6)+Qss(7)) * ones(pipe(12,1).Nx/2+1,1);
pipe(12,1).Ho = pipe(7,2).Ho(pipe(7,2).Nx/2+1) - [0:pipe(12,1).Nx/2]' * 2 * pipe(12,1).R * (Qss(6)+Qss(7)) ^ 2;
pipe(12,2).Qo = (Qss(6)+Qss(7)) * ones(pipe(12,2).Nx/2+1,1);
pipe(12,2).Ho = pipe(12,1).Ho(pipe(12,1).Nx/2+1) - [0:pipe(12,2).Nx/2]' * 2 * pipe(12,2).R * (Qss(6)+Qss(7)) ^ 2;
...
pipe(15,1).Ho = pipe(14,2).Ho(pipe(14,2).Nx/2+1) - [0:pipe(15,1).Nx/2]' * 2 * pipe(15,1).R * (Qss(7)) ^ 2;
